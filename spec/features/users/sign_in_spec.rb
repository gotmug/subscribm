...
require "subscribm/testing_support/subdomain_helpers"
require "subscribm/testing_support/factories/account_factory"

feature "User sign in" do
	extend Subscribm::TestingSupport::SubdomainHelpers
	...
	within_account_subdomain do
		...
		scenario "attempts to sign in with an invalid password and fails" do
			visit subscribm.root_url(:subdomain => account.subdomain)
			expect(page.current_url).to eq(sign_in_url)
